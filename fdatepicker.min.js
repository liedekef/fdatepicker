((t,e)=>{"object"==typeof exports&&"undefined"!=typeof module?module.exports=e():"function"==typeof define&&define.amd?define(e):(t="undefined"!=typeof globalThis?globalThis:t||self).FDatepicker=e()})(this,function(){let a={days:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],daysShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],daysMin:["Su","Mo","Tu","We","Th","Fr","Sa"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],monthsShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],today:"Today",clear:"Clear",close:"Close",format:"m/d/Y h:i a",firstDayOfWeek:0,noDatesSelected:"No dates selected",datesSelected:"Selected dates ({0}):"};class n{static setMessages(t){Object.assign(a,t)}constructor(t,e={}){this.input=t,(this.input._fdatepicker=this).container=this.getOrCreateGlobalContainer(),this.focusedDate=new Date,this.selectedDate=null,this.selectedEndDate=null,this.selectedDates=[],this.isOpen=!1,this.view="days",this.currentYear=(new Date).getFullYear(),this.focusedElement=null,this.options={format:t.dataset.format||"",startView:t.dataset.startView||"days",minDate:t.dataset.minDate?new Date(t.dataset.minDate):null,maxDate:t.dataset.maxDate?new Date(t.dataset.maxDate):null,disabledDates:t.dataset.disabledDates?t.dataset.disabledDates.split(",").map(t=>t.trim()):[],altField:t.dataset.altField||null,altFormat:t.dataset.altFormat||"Y-m-d",range:"true"===t.dataset.range,multiple:"true"===t.dataset.multiple,multipleSeparator:t.dataset.multipleSeparator||",",altFieldMultipleDatesSeparator:t.dataset.altFieldMultipleDatesSeparator||",",multipleDisplaySelector:t.dataset.multipleDisplaySelector||".selected-dates-display",autoClose:"false"!==t.dataset.autoClose,firstDayOfWeek:parseInt(t.dataset.firstDayOfWeek)||0,timepickerDefaultNow:"false"!==t.dataset.timepickerDefaultNow,todayButton:"false"!==t.dataset.todayButton,clearButton:"false"!==t.dataset.clearButton,closeButton:"false"!==t.dataset.closeButton,timepicker:"true"===t.dataset.timepicker,ampm:"false"===t.dataset.ampm,hoursStep:parseInt(t.dataset.hoursStep)||1,minutesStep:parseInt(t.dataset.minutesStep)||1,minHours:void 0!==t.dataset.minHours?parseInt(t.dataset.minHours):null,maxHours:void 0!==t.dataset.maxHours?parseInt(t.dataset.maxHours):null,minMinutes:void 0!==t.dataset.minMinutes?parseInt(t.dataset.minMinutes):0,maxMinutes:void 0!==t.dataset.maxMinutes?parseInt(t.dataset.maxMinutes):59,...e},this.locale=a,this.input.dataset.format||this.options.format||(this.options.format=this.locale.format||"m/d/Y"),(this.options.format.includes("a")||this.options.format.includes("A"))&&(this.options.ampm=!0),this.popup=this.createPopup(),this.title=this.popup.querySelector(".fdatepicker-title"),this.content=this.popup.querySelector(".fdatepicker-content"),this.grid=this.popup.querySelector(".fdatepicker-grid"),this.timepicker=this.popup.querySelector(".fdatepicker-timepicker"),this.hoursInput=this.popup.querySelector('[data-time="hours"]'),this.minutesInput=this.popup.querySelector('[data-time="minutes"]'),this.init()}isDateDisabled(t){var e=t.getTime(),t=this.formatDate(t,"Y-m-d");return!!(this.options.minDate&&e<this.options.minDate.setHours(0,0,0,0))||!!(this.options.maxDate&&e>this.options.maxDate.setHours(23,59,59,999))||!!this.options.disabledDates.includes(t)}getOrCreateGlobalContainer(){let t=document.getElementById("fdatepicker-global-container");return t||((t=document.createElement("div")).id="fdatepicker-global-container",t.className="fdatepicker-global-container",document.body.appendChild(t)),t}wrapInput(){var t=document.createElement("div");return t.style.position="relative",t.style.display="inline-block",t.style.width="100%",this.input.parentNode.insertBefore(t,this.input),t.appendChild(this.input),t}init(){this.initializePrefilledDates(),this.options.timepicker&&(this.timepicker.classList.add("active"),this.options.ampm)&&this.setupAmPm(),this.view="years"===this.options.startView?"years":"months"===this.options.startView?"months":"days",this.render(),this.bindEvents(),this.bindKeyboard(),this.updateInput()}initializePrefilledDates(){var t;this.options.multiple&&this.input.dataset.dates?(t=this.input.dataset.dates.split(","),this.selectedDates=t.map(t=>new Date(t.trim())).filter(t=>!isNaN(t)),0<this.selectedDates.length&&(this.focusedDate=new Date(this.selectedDates[0]))):this.input.dataset.date&&(t=new Date(this.input.dataset.date),isNaN(t)||(this.selectedDate=t,this.focusedDate=new Date(t)))}getInitialTimeValues(){let t=12,e=0,s=!0;var i;this.selectedDate?(t=this.selectedDate.getHours(),e=this.selectedDate.getMinutes(),s=t<12):this.options.timepickerDefaultNow&&(i=new Date,t=i.getHours(),e=i.getMinutes(),s=t<12);let a=t;return{hours:a=this.options.ampm?0===t?12:12<t?t-12:t:a,minutes:e,isAM:s}}createPopup(){var s=document.createElement("div");if(s.className="fdatepicker-popup",s.innerHTML=`
        ...
        `,this.options.timepicker){var i=this.getInitialTimeValues(),a=!this.options.ampm;let t,e;e=null!==this.options.minHours&&null!==this.options.maxHours?(t=this.options.minHours,this.options.maxHours):a?(t=null!==this.options.minHours?this.options.minHours:0,null!==this.options.maxHours?this.options.maxHours:23):(t=null!==this.options.minHours?this.options.minHours:1,null!==this.options.maxHours?this.options.maxHours:12);var a=a?`
                <input type="number"
                    ...
                    value="${String(i.hours).padStart(2,"0")}">
            `:`
                <input type="number"
                    class="fdatepicker-time-input"
                    data-time="hours"
                    ...
                    step="${this.options.hoursStep}"
                    value="${String(i.hours).padStart(2,"0")}">
                <div class="fdatepicker-time-ampm ${i.isAM?"active":""}" data-ampm="AM">AM</div>
                <div class="fdatepicker-time-ampm ${i.isAM?"":"active"}" data-ampm="PM">PM</div>
            `,n=document.createElement("div");n.className="fdatepicker-timepicker",n.innerHTML=`
