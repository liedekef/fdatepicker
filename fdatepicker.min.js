((t,e)=>{"object"==typeof exports&&"undefined"!=typeof module?module.exports=e():"function"==typeof define&&define.amd?define(e):(t="undefined"!=typeof globalThis?globalThis:t||self).FDatepicker=e()})(this,function(){let h={days:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],daysShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],daysMin:["Su","Mo","Tu","We","Th","Fr","Sa"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],monthsShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],today:"Today",clear:"Clear",close:"Close",format:"m/d/Y h:i a",firstDayOfWeek:0,noDatesSelected:"No dates selected",datesSelected:"Selected dates ({0}):"};class d{static setMessages(t){Object.assign(h,t)}constructor(t,e={}){if(this.input="string"==typeof t?document.querySelector(t):t,this.input){if(this.input._fdatepicker)return this.input._fdatepicker;(this.input._fdatepicker=this).container=this.getOrCreateGlobalContainer(),this.focusedDate=new Date,this.selectedDate=null,this.selectedEndDate=null,this.selectedDates=[],this.isOpen=!1,this.view="days",this.currentYear=(new Date).getFullYear(),this.focusedElement=null,this.options={format:this.input.dataset.format||"",startView:this.input.dataset.startView||"days",minDate:this.input.dataset.minDate?new Date(this.input.dataset.minDate):null,maxDate:this.input.dataset.maxDate?new Date(this.input.dataset.maxDate):null,disabledDates:this.input.dataset.disabledDates?this.input.dataset.disabledDates.split(",").map(t=>t.trim()):[],altField:this.input.dataset.altField||null,altFormat:this.input.dataset.altFormat||"Y-m-d",range:"true"===this.input.dataset.range,multiple:"true"===this.input.dataset.multiple,multipleSeparator:this.input.dataset.multipleSeparator||",",altFieldMultipleSeparator:this.input.dataset.altFieldMultipleSeparator||",",multipleDisplaySelector:this.input.dataset.multipleDisplaySelector||".selected-dates-display",autoClose:"false"!==this.input.dataset.autoClose,firstDayOfWeek:parseInt(this.input.dataset.firstDayOfWeek)||0,todayButton:"false"!==this.input.dataset.todayButton,clearButton:"false"!==this.input.dataset.clearButton,closeButton:"false"!==this.input.dataset.closeButton,timepicker:"true"===this.input.dataset.timepicker,timeOnly:"true"===this.input.dataset.timeOnly,timepickerDefaultNow:"false"!==this.input.dataset.timepickerDefaultNow,ampm:"false"===this.input.dataset.ampm,hoursStep:parseInt(this.input.dataset.hoursStep)||1,minutesStep:parseInt(this.input.dataset.minutesStep)||1,minHours:void 0!==this.input.dataset.minHours?parseInt(this.input.dataset.minHours):null,maxHours:void 0!==this.input.dataset.maxHours?parseInt(this.input.dataset.maxHours):null,minMinutes:void 0!==this.input.dataset.minMinutes?parseInt(this.input.dataset.minMinutes):0,maxMinutes:void 0!==this.input.dataset.maxMinutes?parseInt(this.input.dataset.maxMinutes):59,onSelect:"function"==typeof this.input.dataset.onSelect?this.input.dataset.onSelect:null,...e},this.locale=h,this.options.timeOnly&&(this.options.autoClose=!1,this.options.todayButton=!1,this.options.clearButton=!1),this.input.dataset.format||this.options.format||(this.options.format=this.locale.format||"m/d/Y"),(this.options.format.includes("a")||this.options.format.includes("A"))&&(this.options.ampm=!0),this.popup=this.createPopup(),this.title=this.popup.querySelector(".fdatepicker-title"),this.content=this.popup.querySelector(".fdatepicker-content"),this.grid=this.popup.querySelector(".fdatepicker-grid"),this.timepicker=this.popup.querySelector(".fdatepicker-timepicker"),this.hoursInput=this.popup.querySelector('[data-time="hours"]'),this.minutesInput=this.popup.querySelector('[data-time="minutes"]'),this.init()}}isDateDisabled(t){var e=t.getTime(),t=this.formatDate(t,"Y-m-d");return!!(this.options.minDate&&e<this.options.minDate.setHours(0,0,0,0))||!!(this.options.maxDate&&e>this.options.maxDate.setHours(23,59,59,999))||!!this.options.disabledDates.includes(t)}getOrCreateGlobalContainer(){let t=document.getElementById("fdatepicker-global-container");return t||((t=document.createElement("div")).id="fdatepicker-global-container",t.className="fdatepicker-global-container",document.body.appendChild(t)),t}wrapInput(){var t=document.createElement("div");return t.style.position="relative",t.style.display="inline-block",t.style.width="100%",this.input.parentNode.insertBefore(t,this.input),t.appendChild(this.input),t}init(){this.initializePrefilledDates(),this.options.timepicker&&(this.timepicker.classList.add("active"),this.options.ampm)&&this.setupAmPm(),this.view="years"===this.options.startView?"years":"months"===this.options.startView?"months":"days",this.render(),this.bindEvents(),this.bindKeyboard(),this.updateInput()}initializePrefilledDates(){var t;this.options.multiple&&this.input.dataset.dates?(t=this.input.dataset.dates.split(","),this.selectedDates=t.map(t=>new Date(t.trim())).filter(t=>!isNaN(t)),0<this.selectedDates.length&&(this.focusedDate=new Date(this.selectedDates[0]))):this.input.dataset.date&&(t=new Date(this.input.dataset.date),isNaN(t)||(this.selectedDate=t,this.focusedDate=new Date(t)))}getInitialTimeValues(){let t=12,e=0,s=!0;var i;this.selectedDate?(t=this.selectedDate.getHours(),e=this.selectedDate.getMinutes(),s=t<12):this.options.timepickerDefaultNow&&(i=new Date,t=i.getHours(),e=i.getMinutes(),s=t<12);let a=t;return{hours:a=this.options.ampm?0===t?12:12<t?t-12:t:a,minutes:e,isAM:s}}createPopup(){var s=document.createElement("div");if(s.className="fdatepicker-popup",this.options.timeOnly||(s.innerHTML=`
        ...
        `),this.options.timepicker){var i=this.getInitialTimeValues(),a=!this.options.ampm;let t,e;e=null!==this.options.minHours&&null!==this.options.maxHours?(t=this.options.minHours,this.options.maxHours):a?(t=null!==this.options.minHours?this.options.minHours:0,null!==this.options.maxHours?this.options.maxHours:23):(t=null!==this.options.minHours?this.options.minHours:1,null!==this.options.maxHours?this.options.maxHours:12);var a=`
                <input type="number"
            ...
            `,o=document.createElement("div");o.className="fdatepicker-timepicker",o.innerHTML=`
